        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder={t('leaveBlankForAutoGeneratedId')}
            />
          </div>
          ...
          <div className="border-t pt-4">
            <div className="flex justify-between items-center mb-2">
              ...
              >
                {showNonSerial ? '- ' + t('removeSection') : '+ ' + t('addSection')}
              </button>
            </div>
            {showNonSerial && (
                    ...
                    <div className="flex-1">
                      ...
                      {productDetails[item.boxBarcode] && (
                        <div className="mt-1 text-sm text-gray-600">
                          {t('product')}: {productDetails[item.boxBarcode].productName}
                        </div>
                      )}
                    </div>
                    <div className="w-24">
          ...
          <div className="border-t pt-4">
            <div className="flex justify-between items-center mb-2">
              ...
              <button
                ...
                className="text-blue-600 hover:text-blue-800 text-sm font-medium"
              >
                {showSerial ? '- ' + t('removeSection') : '+ ' + t('addSection')}
              </button>
            </div>
            {showSerial && (
                        ...
                        {productDetails[group.boxBarcode] && (
                          <div className="mt-2 text-sm">
                            <div className="text-gray-600">
                              {t('product')}: {productDetails[group.boxBarcode].productName}
